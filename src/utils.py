...
def remove_silence_edges(audio, silence_threshold=-42):
    ...
    return trimmed_audio, trimmed_audio.duration_seconds
...
def preprocess_ref_audio_text(ref_audio_orig, ref_text, clip_short=True, show_info=print, device=device):
    ...
    trimmed_audio, duration = remove_silence_edges(aseg)
    aseg = trimmed_audio + AudioSegment.silent(duration=50)
    aseg.export(ref_audio_orig, format="wav")
    ...
    return ref_audio, ref_text, duration + AudioSegment.silent(duration=50).duration_seconds
